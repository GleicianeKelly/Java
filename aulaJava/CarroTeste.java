...
public class CarroTeste {
	...
	public static void opcao() {
			...
			while(true) {
				...
				System.out.println("**************");
				System.out.println("Para inserir digite 1");
				System.out.println("Para listar digite 2: ");
				System.out.println("Para pesquisar digite 3: ");
	...
	public static void inserir() {
		...
		while(true) {
			...
			System.out.println("Informe [S] para sim ou [N]"
					+ "para não: ");
